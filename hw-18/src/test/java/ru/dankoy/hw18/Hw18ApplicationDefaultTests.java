...
import ru.dankoy.hw18.core.controller.BookRestController;
import ru.dankoy.hw18.core.controller.CommentaryRestController;
import ru.dankoy.hw18.core.dto.mapper.BookMapper;
import ru.dankoy.hw18.core.dto.mapper.CommentaryMapper;
import ru.dankoy.hw18.core.repository.author.AuthorRepository;
import ru.dankoy.hw18.core.repository.book.BookRepository;
...
import ru.dankoy.hw18.core.service.objectmapper.ObjectMapperServiceImpl;

@DisplayName("Test default context ")
@SpringBootTest
class Hw18ApplicationDefaultTests {
