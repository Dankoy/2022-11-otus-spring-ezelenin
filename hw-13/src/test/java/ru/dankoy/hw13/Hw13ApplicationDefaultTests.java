...
import ru.dankoy.hw13.core.controller.BookController;
import ru.dankoy.hw13.core.controller.CommentaryController;
import ru.dankoy.hw13.core.dto.book.mapper.BookMapper;
import ru.dankoy.hw13.core.dto.commentary.mapper.CommentaryMapper;
import ru.dankoy.hw13.core.repository.author.AuthorRepository;
import ru.dankoy.hw13.core.repository.book.BookRepository;
import ru.dankoy.hw13.core.repository.genre.GenreRepository;
import ru.dankoy.hw13.core.service.author.AuthorServiceJpa;
import ru.dankoy.hw13.core.service.book.BookDtoServiceImpl;
import ru.dankoy.hw13.core.service.book.BookServiceJpa;
import ru.dankoy.hw13.core.service.commentary.CommentaryDtoServiceImpl;
import ru.dankoy.hw13.core.service.genre.GenreServiceJpa;
import ru.dankoy.hw13.core.service.objectmapper.ObjectMapperServiceImpl;

@DisplayName("Test default context ")
@SpringBootTest
class Hw13ApplicationDefaultTests {
