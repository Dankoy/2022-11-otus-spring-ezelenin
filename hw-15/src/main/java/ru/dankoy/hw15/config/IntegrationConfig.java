...
public class IntegrationConfig {
  ...
  public IntegrationFlow morphingFlow(XenomorphingService xenomorphingService,
    ...
    return IntegrationFlows
        ...
        // По-хорошему нужен отдельный сервис, который бы проверял внешние условия, что жертв достаточно,
        // в зависимости от, например, отдельного объекта, содержащего количество жертв с разными параметрами,
        // которые, в свою очередь влияли на шкалу насыщенности дрона для эволюции
        ...
        // В зависимости от заголовка сообщения, происходит роутинг в один из двух каналов
        .route(droneRouter())
        .get();
  }
