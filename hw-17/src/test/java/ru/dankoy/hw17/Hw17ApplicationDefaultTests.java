...
import ru.dankoy.hw17.core.controller.BookRestController;
import ru.dankoy.hw17.core.controller.CommentaryRestController;
import ru.dankoy.hw17.core.dto.mapper.BookMapper;
import ru.dankoy.hw17.core.dto.mapper.CommentaryMapper;
import ru.dankoy.hw17.core.repository.author.AuthorRepository;
import ru.dankoy.hw17.core.repository.book.BookRepository;
import ru.dankoy.hw17.core.service.author.AuthorServiceMongo;
import ru.dankoy.hw17.core.service.book.BookServiceMongo;
import ru.dankoy.hw17.core.service.genre.GenreServiceMongo;
import ru.dankoy.hw17.core.service.objectmapper.ObjectMapperServiceImpl;

@DisplayName("Test default context ")
@SpringBootTest
class Hw17ApplicationDefaultTests {
