...
import ru.dankoy.hw16.core.controller.BookController;
import ru.dankoy.hw16.core.controller.CommentaryController;
import ru.dankoy.hw16.core.dto.book.mapper.BookMapper;
...
import ru.dankoy.hw16.core.repository.genre.GenreRepository;
import ru.dankoy.hw16.core.service.author.AuthorServiceJpa;
import ru.dankoy.hw16.core.service.book.BookDtoServiceImpl;
import ru.dankoy.hw16.core.service.book.BookServiceJpa;
import ru.dankoy.hw16.core.service.commentary.CommentaryDtoServiceImpl;
import ru.dankoy.hw16.core.service.genre.GenreServiceJpa;
import ru.dankoy.hw16.core.service.objectmapper.ObjectMapperServiceImpl;

@DisplayName("Test default context ")
@SpringBootTest
class Hw16ApplicationDefaultTests {
